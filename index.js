...
const addNewGoal = () => {
    ...
    existingGoals.forEach(goal => {
        console.log('Existing Goal: "${goalInput}"');
    }

    )

    const isDuplicate = existingGoals.some(goal => goal.textContent.trim().toLowerCase() === goalInput.toLowerCase());
